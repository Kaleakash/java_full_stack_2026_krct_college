...
throws
throws keyword use to throw checked or unchecked or custom exception to 
caller methods. 

throws is used in a method declaration to tell the 
caller that the method may throw one or more exceptions.
